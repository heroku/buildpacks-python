...
- The Python 3.14 version alias now resolves to Python 3.14.7. ([#604](https://github.com/heroku/buildpacks-python/pull/604))
- The Python 3.13 version alias now resolves to Python 3.13.15. ([#604](https://github.com/heroku/buildpacks-python/pull/604))

## [6.5.5] - 2026-07-30

### Changed

- Updated uv from 0.11.28 to 0.11.33. ([#598](https://github.com/heroku/buildpacks-python/pull/598))

## [6.5.4] - 2026-07-10

### Changed

- Updated uv from 0.11.19 to 0.11.28. ([#589](https://github.com/heroku/buildpacks-python/pull/589))
...
- Updated pip from 26.1.1 to 26.1.2. ([#576](https://github.com/heroku/buildpacks-python/pull/576))
- Updated Poetry from 2.4.0 to 2.4.1. ([#576](https://github.com/heroku/buildpacks-python/pull/576))
- Updated uv from 0.11.11 to 0.11.19. ([#576](https://github.com/heroku/buildpacks-python/pull/576))
...
- Updated Poetry from 2.3.3 to 2.3.4. ([#553](https://github.com/heroku/buildpacks-python/pull/553))
- Updated uv from 0.11.3 to 0.11.6. ([#552](https://github.com/heroku/buildpacks-python/pull/552))
...
- Updated Poetry from 2.3.2 to 2.3.3. ([#532](https://github.com/heroku/buildpacks-python/pull/532))
...
- Updated uv from 0.10.1 to 0.10.7. ([#518](https://github.com/heroku/buildpacks-python/pull/518))
...
- Updated uv from 0.9.29 to 0.10.1. ([#510](https://github.com/heroku/buildpacks-python/pull/510))
...
- The Python 3.13 version alias now resolves to Python 3.13.12. ([#503](https://github.com/heroku/buildpacks-python/pull/503))
...
- Updated uv from 0.9.24 to 0.9.26. ([#492](https://github.com/heroku/buildpacks-python/pull/492))
...
- Updated pip from 25.2 to 25.3. ([#453](https://github.com/heroku/buildpacks-python/pull/453))

## [3.0.2] - 2026-01-05

### Changed

- Updated uv from 0.9.17 to 0.9.21. ([#486](https://github.com/heroku/buildpacks-python/pull/486))

## [3.0.1] - 2025-12-10

### Changed

- Updated uv from 0.9.14 to 0.9.17. ([#482](https://github.com/heroku/buildpacks-python/pull/482))
...
- The Python 3.14 version alias now resolves to Python 3.14.1. ([#476](https://github.com/heroku/buildpacks-python/pull/476))
- The Python 3.13 version alias now resolves to Python 3.13.10. ([#476](https://github.com/heroku/buildpacks-python/pull/476))
- Updated uv from 0.9.11 to 0.9.14. ([#474](https://github.com/heroku/buildpacks-python/pull/474))
...
[unreleased]: https://github.com/heroku/buildpacks-python/compare/v6.6.0...HEAD
...
[6.5.6]: https://github.com/heroku/buildpacks-python/compare/v6.5.5...v6.5.6
[6.5.5]: https://github.com/heroku/buildpacks-python/compare/v6.5.4...v6.5.5
[6.5.4]: https://github.com/heroku/buildpacks-python/compare/v6.5.3...v6.5.4
[6.5.3]: https://github.com/heroku/buildpacks-python/compare/v6.5.2...v6.5.3
[6.5.2]: https://github.com/heroku/buildpacks-python/compare/v6.5.1...v6.5.2
[6.5.1]: https://github.com/heroku/buildpacks-python/compare/v6.5.0...v6.5.1
...
[3.0.1]: https://github.com/heroku/buildpacks-python/compare/v3.0.0...v3.0.1
[3.0.0]: https://github.com/heroku/buildpacks-python/compare/v2.8.1...v3.0.0
[2.8.1]: https://github.com/heroku/buildpacks-python/compare/v2.8.0...v2.8.1
